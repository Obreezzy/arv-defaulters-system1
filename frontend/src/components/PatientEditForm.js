...
import { User, MapPin, Heart, Phone, Building2, X, Save } from 'lucide-react';
...
function PatientEditForm({ patient, onClose, onSuccess }) {
 ...
 distance_from_clinic: patient.distance_from_clinic != null ? String(Math.round(parseFloat(patient.distance_from_clinic))) : '',
 ...
 distance_from_clinic: formData.distance_from_clinic !== '' ? parseInt(formData.distance_from_clinic, 10) : null,
 };
 ...
 <small style={{ color: '#6b7280', fontSize: '0.75rem' }}>Whole numbers only (e.g. 9)</small>
 </div>
 </div>
