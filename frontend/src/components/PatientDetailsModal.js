    ...
    <div className="modal-overlay">
      <div className="modal-content">
                                      ...
                                      <div className="timeline-content">
                                          <div className="timeline-header">
                                              ...
                                              <div style={{ display: 'flex', gap: '0.5rem' }}>
                                                {isLate && <span className="badge-late">⚠️ {daysLate}d Late</span>}
                                                {!isLate && scheduledForThisVisit && <span className="badge-ontime">✅ On Time</span>}
                                                {isRecent && <span className="badge-new">Latest</span>}
                                              </div>
                                          </div>
        ...
        <div className="modal-footer">
          ...
          <button className="btn-primary" onClick={() => onEdit(patient)}>✏️ Edit Details</button>
        </div>
      </div>
    </div>
  );
