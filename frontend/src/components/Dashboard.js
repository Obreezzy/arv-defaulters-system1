...
import { UserPlus, Pill, FileText, MessageSquare, Users, AlertTriangle, Activity, CheckCircle } from 'lucide-react';
...
const ALERT_TYPES = [
 ...
 { value: 'heavy_rain', label: ' Heavy Rains', riskBoost: 20 },
 { value: 'cyclone', label: ' Cyclone Warning', riskBoost: 45 },
 { value: 'road_closure', label: ' Road Closure', riskBoost: 25 },
 { value: 'drought', label: ' Extreme Heat/Drought', riskBoost: 15 },
];
...
function WeatherAlertModal({ onClose, onSave }) {
 ...
 <h3> Set Weather / Disaster Alert</h3>
...
function Dashboard({ onNavigate, currentUser }) {
 ...
 <StatCard title="Missed Pickups" value={stats.activeDefaulters} icon="" color="#ef4444" />
 </div>
 ...
 <div className="alert-header"><AlertTriangle size={20} color="#f59e0b" /><h4>Medium Risk Candidates</h4></div>
